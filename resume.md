...
<div class="md:flex md:flex-row sm:gap-8 mb-6">
    <div class="mb-16 md:mb-0" style="flex:1">
        <img src="/assets/images/twelve-days-of-cryptoart.png" alt="">
    ...
    <div class="mb-16 md:mb-0" style="flex:1">
        <img src="/assets/images/wallace-museum.png" alt="">
...
<div class="md:flex md:flex-row sm:gap-8 mb-6">
    <div class="mb-16 md:mb-0" style="flex:1">
        <img src="/assets/images/woodies-origin.png" alt="">
    ...
    <div class="mb-16 md:mb-0" style="flex:1">
        <img src="/assets/images/california-dmv.png" alt="">
...
<div class="md:flex md:flex-row sm:gap-8 mb-6">
    <div class="mb-16 md:mb-0" style="flex:1">
        <img src="/assets/images/starbucks-stories.png" alt="">
    ...
    <div class="mb-16 md:mb-0" style="flex:1">
        <img src="/assets/images/google-site-kit.png" alt="">
